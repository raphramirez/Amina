...
internal class ApplicationDatabaseInitializer : IDatabaseInitializer
{
    ...
    public ApplicationDatabaseInitializer(TenantDbContext tenantDbContext, IServiceProvider serviceProvider, IConfiguration config, TenantDbInitializer tenantDbInitializer)
    {
